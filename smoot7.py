...
class RobotArm:
    ...
    def scan(self):
        # UNO จะ set ไฟแดงอัตโนมัติเมื่อ SCAN
    ...
    try:
        while True:
            ...
            if state == "WAIT_ARM":
                ...
                if not armed:
                    ...
                    if cached_book:
                        ...
                        # ✅ รอให้ไปถึงท่าหนังสือก่อนค่อย BOOK_HOLD ON
                        wait_pose_done()
                        robot.book_hold_on()
                ...
                if not armed:
                    ...
                    # ✅ รอให้ถึงท่าก่อนค่อย HOLD ไม่งั้นค้างกลางทาง
                    wait_pose_done()
                    robot.hold()
            ...
            if Config.SHOW_WINDOW:
                ...
                cv2.imshow("Controller (Full Fixed)", frame)
